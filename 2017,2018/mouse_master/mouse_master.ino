...
// distance sensors
VL6180X* frontIR = new VL6180X;
VL6180X* leftIR = new VL6180X;
VL6180X* rightDiagIR = new VL6180X;
VL6180X* leftDiagIR = new VL6180X;
VL6180X* rightIR = new VL6180X;
std::vector<int> sensor_pins = {pins::tofLeft, pins::tofLeftDiag, pins::tofFront, pins::tofRightDiag, pins::tofRight};
std::vector<VL6180X*> sensors = {leftIR, leftDiagIR, frontIR, rightDiagIR, rightIR};
 ...
 *       HARDWARE CODE         *
 * * * * * * * * * * * * * * * */
 /* initializes a sensor using the reset pin */
void initSensor(int pin, VL6180X *sensor, int address) {
