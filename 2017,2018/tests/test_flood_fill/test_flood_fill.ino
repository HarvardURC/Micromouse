/*
 * Tests the floodfill algorithm for solving the maze.
 * When connected to the teensy, the serial monitor shows the 
 * mouse position with "@@@" and a sample maze with walls and floodfill distances at each cell.
 * The @@@ moves through and solves the maze according to the floodfill algorithm.
 */
